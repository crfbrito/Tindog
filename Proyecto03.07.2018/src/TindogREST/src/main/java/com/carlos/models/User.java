...
public class User {
	...
	public User(int tindogId, String name, String email, int matchId, String password, int locationId,
	...
	public int getTindogId() {
		return tindogId;
	}

	public void setTindogId(int tindogId) {
		this.tindogId = tindogId;
	}
